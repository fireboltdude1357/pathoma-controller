...
must_haves:
  ...
  key_links:
    - from: "extension/manifest.json"
      to: "extension/dist/background.js"
      via: "service_worker field pointing to compiled output"
      pattern: "service_worker.*dist/background\\.js"
---
...
- background.service_worker: "dist/background.js" (compiled output path)
